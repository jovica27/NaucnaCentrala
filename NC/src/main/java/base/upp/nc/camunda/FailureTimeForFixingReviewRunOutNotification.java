...
@Component
public class FailureTimeForFixingReviewRunOutNotification implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
    	...
    	String mailContent = "We are sorry, your scientific wrok is rejected because time for fixing content run out.";

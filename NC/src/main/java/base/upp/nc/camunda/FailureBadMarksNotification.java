...
@Component
public class FailureBadMarksNotification implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
    	...
    	String mailContent = "We are sorry, your scientific wrok is rejected because it has bad marks.";
